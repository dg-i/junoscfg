#!/usr/bin/env bash
#
# integration_test.sh — Minimal live-device test for junoscfg
#
...
#
# Usage:  ./integration_test.sh [options] <hostname>
#
# Options:
...
Examples:
  ./integration_test.sh myswitch
  ./integration_test.sh --quiet-ssh myswitch
  ./integration_test.sh --anonymize-networks auto myswitch
  ./integration_test.sh --anonymize-network-file subnets.txt myswitch
EOF
    exit 0
}
